...
public:
    ...
    int readDataBlock(unsigned char blockNumber, unsigned char blockData[], unsigned char *dataLength);
...
int TagReader::readDataBlock(unsigned char blockNumber, unsigned char blockData[], unsigned char *dataLength) {
